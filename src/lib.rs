...
pub fn analyze_features(
    ...
    let tier1_wants_laplacian = features.intersects(
        feature::FeatureSet::new()
            ...
            .with(feature::AnalysisFeature::LaplacianVarianceP1)
            .with(feature::AnalysisFeature::LaplacianVarianceP5)
            .with(feature::AnalysisFeature::LaplacianVarianceP10)
            .with(feature::AnalysisFeature::LaplacianVarianceP15)
            .with(feature::AnalysisFeature::LaplacianVarianceP20)
            .with(feature::AnalysisFeature::LaplacianVarianceP25)
            .with(feature::AnalysisFeature::LaplacianVarianceP30)
            .with(feature::AnalysisFeature::LaplacianVarianceP35)
            .with(feature::AnalysisFeature::LaplacianVarianceP40)
            .with(feature::AnalysisFeature::LaplacianVarianceP45)
            .with(feature::AnalysisFeature::LaplacianVarianceP50)
            .with(feature::AnalysisFeature::LaplacianVarianceP55)
            .with(feature::AnalysisFeature::LaplacianVarianceP60)
            .with(feature::AnalysisFeature::LaplacianVarianceP65)
            .with(feature::AnalysisFeature::LaplacianVarianceP70)
            .with(feature::AnalysisFeature::LaplacianVarianceP75)
            .with(feature::AnalysisFeature::LaplacianVarianceP80)
            .with(feature::AnalysisFeature::LaplacianVarianceP85)
            .with(feature::AnalysisFeature::LaplacianVarianceP90)
            .with(feature::AnalysisFeature::LaplacianVarianceP95)
