...
fn dct_stats<R: ChunkInput>(stream: &mut RowStream<'_>, max_blocks: usize) -> Tier3DctStats {
    ...
    if width < 8 || height < 8 {
        return Tier3DctStats {
            ...
            aq_map_mean: 0.0,
            aq_map_std: 0.0,
            // #49: with zero sampled blocks the percentile / windowed
            // features are UNDEFINED — emit NaN (which `into_results`
            // drops to `None`) so a too-small input reports them honestly
            // rather than as a misleading 0.0. `analyze_features` recovers
            // them by mirror-tiling. The non-percentile means below stay
            // 0.0 (their value over zero blocks).
            aq_map_p1: f32::NAN,
            aq_map_p5: f32::NAN,
            aq_map_p10: f32::NAN,
            aq_map_p50: f32::NAN,
            ...
            noise_floor_y: 0.0,
            noise_floor_uv: 0.0,
            noise_floor_y_p1: f32::NAN,
            noise_floor_y_p5: f32::NAN,
            noise_floor_y_p10: f32::NAN,
            noise_floor_y_p25: f32::NAN,
            noise_floor_y_p50: f32::NAN,
            noise_floor_y_p75: f32::NAN,
            noise_floor_y_p90: f32::NAN,
            noise_floor_uv_p25: f32::NAN,
            noise_floor_uv_p50: f32::NAN,
            noise_floor_uv_p75: f32::NAN,
            noise_floor_uv_p90: f32::NAN,
            gradient_fraction: 0.0,
            gradient_fraction_smooth: 0.0,
            patch_fraction_fast: 0.0,
            quant_survival_y: 0.0,
            quant_survival_uv: 0.0,
            quant_survival_y_p1: f32::NAN,
            quant_survival_y_p5: f32::NAN,
            quant_survival_y_p10: f32::NAN,
            quant_survival_y_p25: f32::NAN,
            quant_survival_y_p50: f32::NAN,
            quant_survival_y_p75: f32::NAN,
            quant_survival_uv_p10: f32::NAN,
            quant_survival_uv_p25: f32::NAN,
            quant_survival_uv_p50: f32::NAN,
            quant_survival_uv_p75: f32::NAN,
            info_weight_mean: 0.0,
            info_weight_p90: f32::NAN,
