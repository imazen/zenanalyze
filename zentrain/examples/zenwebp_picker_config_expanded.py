...
PARETO = Path("benchmarks/zenwebp_pareto_expanded_2026-05-02.tsv")
FEATURES = Path("benchmarks/zenwebp_features_expanded_2026-05-02.tsv")

OUT_JSON = Path("benchmarks/zenwebp_hybrid_expanded_2026-05-02.json")
OUT_LOG = Path("benchmarks/zenwebp_hybrid_expanded_2026-05-02.log")
